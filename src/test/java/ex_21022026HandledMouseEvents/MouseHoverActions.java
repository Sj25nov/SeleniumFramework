...
MouseHover.moveToElement(MouseHovering).moveToElement(solutions).click().build().perform();

String ActualUrl="https://www.orangehrm.com/en/30-day-free-trial";
if(ActualUrl.equals(driver.getCurrentUrl()))
        {
            System.out.println("Testcaseee PAsseddd............!!!");
        }
    }
}
