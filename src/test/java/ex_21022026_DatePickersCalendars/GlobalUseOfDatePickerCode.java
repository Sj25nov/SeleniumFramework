...
public class GlobalUseOfDatePickerCode {


    static void datepicker(WebDriver driver,String year,String month){
        while(true){
    ...
    static void daypicker(WebDriver driver,String day){
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        datepicker(driver,year,month);
        daypicker(driver,day);
        Thread.sleep(5000);
       /* while(true){
            String ExpectedMonth=driver.findElement(By.xpath("//span[@class='ui-datepicker-month']")).getText();
            String ExpectedYear=driver.findElement(By.xpath("//span[@class='ui-datepicker-year']")).getText();
